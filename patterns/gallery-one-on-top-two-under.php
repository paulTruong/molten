...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--custom--spacing--gap--vertical, 32px);padding-bottom:var(--wp--custom--spacing--gap--vertical, 32px)">
    ...
    <figure class="wp-block-image size-full"><img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/cafe-barista-min.jpg' ?>" alt="" class="wp-image-14" /></figure>
    <!-- /wp:image -->
    ...
    <figure class="wp-block-gallery aligncenter has-nested-images columns-default is-cropped">
        ...
        <figure class="wp-block-image size-large"><img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/coffee-pour-min.jpg' ?>" alt="" class="wp-image-16" /></figure>
        <!-- /wp:image -->

        <!-- wp:image {"id":15,"sizeSlug":"large","linkDestination":"none"} -->
        <figure class="wp-block-image size-large"><img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/bagel-and-coffee-min.jpg' ?>" alt="" class="wp-image-15" /></figure>
        <!-- /wp:image -->
    </figure>
    <!-- /wp:gallery -->
</div>
