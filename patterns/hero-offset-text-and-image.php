 ...
 */
?>
<!-- wp:heading {"textAlign":"left","align":"wide","style":{"spacing":{"margin":{"top":"var(--wp--custom--spacing--gap--vertical, 32px)"}}},"fontSize":"huge"} -->
<h2 class="alignwide has-text-align-left has-huge-font-size" style="margin-top:var(--wp--custom--spacing--gap--vertical, 32px)">Fresh, locally sourced produce <br>in a relaxed atmosphere</h2>
<!-- /wp:heading -->

<!-- wp:columns {"verticalAlignment":null,"style":{"spacing":{"margin":{"top":"var(--wp--custom--spacing--gap--vertical, 32px)"}}},"align":"wide"} -->
<div class="wp-block-columns alignwide" style="margin-top:var(--wp--custom--spacing--gap--vertical, 32px);">
    ...
    <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:70%">
        <!-- wp:image {"id":233,"width":960,"height":720,"sizeSlug":"full","linkDestination":"none"} -->
